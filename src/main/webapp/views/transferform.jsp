...
<table border="1">
    ...
    <h3 style="color:mediumblue;">TRANSFER FORM</h3></center>
    <form action="transfer">
<center><tr> <td>  Account Number:</td><td><input type="number" name="saccount_number"><br><br>
	<tr> <td>  Name:</td><td><input type="text" name="name"><br><br>
    <tr> <td>    Password:</td><td><input type="password" name="password"><br><br>
    <tr> <td>    Target Account No:</td><td><input type="number" name="taccount_number"><br><br>
